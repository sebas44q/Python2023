...
# resultado esperado: El precio de la compra tras aplicar los descuentos es: 1349.0

print('El precio de la compra tras aplicar el IVA es:', price_basket({1000: 20, 500: 10, 100: 1}, apply_IVA))
# resultado esperado: El precio de la compra tras aplicar el IVA es: 1851.0
